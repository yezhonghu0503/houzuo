...
let refurbishColorinput = ref(["房间面积","铲批面积"])
...
<template>
  <el-row :gutter="5" class="tool-menu" justify="center">
    <el-col v-for="item in refurbishColorinput.value" :span="6">
      <div class="tool-main">
      ...
      <div class="tool-main">
        ...
        <div class="ref-tool-parameter">
          <el-dropdown class="ref-tool-dropdown">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="getToolSelect(index, $event)" v-for="items in item.selectlist">{{ items }}
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25"
      ...
      <g opacity="1" transform="translate(0 0)  rotate(0 15 15)">
        ...
        <g mask="url(#bg-mask-0)">
          <path id="路径 1" fill-rule="evenodd" style="fill: #e9e9e9" transform="translate(0 0)  rotate(0 15 15)"
            opacity="0.01" d="M0,30L30,30L30,0L0,0L0,30Z " />
          <path id="路径 2" style="
              stroke: #383838;
          ...
          <path id="路径 4" style="
              ...
              stroke-opacity: 1;
              stroke-dasharray: 0 0;
            " transform="translate(3.75 8.124999999999998)  rotate(0 4.999999999999999 0)" d="M0,0L10,0 " />
          <path id="路径 5" style="
              stroke: #383838;
              stroke-width: 1.3333333333333333;
              stroke-opacity: 1;
              stroke-dasharray: 0 0;
            " transform="translate(8.749999999999998 3.1249999999999996)  rotate(0 0 5)" d="M0,0L0,10 " />
          <path id="路径 6" style="
              stroke: #383838;
              stroke-width: 1.3333333333333333;
              stroke-opacity: 1;
              stroke-dasharray: 0 0;
            " transform="translate(3.75 3.1249999999999996)  rotate(0 11.25 11.249999999999998)" d="M22.5,0L0,22.5 " />
        </g>
      </g>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25"
      ...
      <g opacity="1" transform="translate(0 0)  rotate(0 15 15)">
        ...
        <g mask="url(#bg-mask-0)">
          <path id="路径 1" style="
              ...
              stroke-opacity: 1;
              stroke-dasharray: 0 0;
            " transform="translate(26.25 4.999999999999999)  rotate(0 0 5)" d="M0,0L0,10 " />
          <path id="路径 2" style="
              stroke: #383838;
              stroke-width: 1.3333333333333333;
              stroke-opacity: 1;
              stroke-dasharray: 0 0;
            " transform="translate(3.75 15)  rotate(0 0 4.999999999999998)" d="M0,0L0,10 " />
          <path id="路径 3" style="
              stroke: #383838;
              stroke-width: 1.3333333333333333;
              stroke-opacity: 1;
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25"
      ...
      <g opacity="0.81" transform="translate(0 0)  rotate(0 15 15)">
        ...
        <g mask="url(#bg-mask-0)">
          <path id="路径 1" fill-rule="evenodd" style="fill: #e9e9e9" transform="translate(0 0)  rotate(0 15 15)"
            opacity="0.01" d="M0,30L30,30L30,0L0,0L0,30Z " />
          <path id="路径 2" fill-rule="evenodd" style="fill: #333333"
            transform="translate(18.75 3.75)  rotate(0 3.1249999999999996 3.1249999999999996)" opacity="1"
          ...
          <path id="路径 2" style="
            ...
            d="M6.25,3.12C6.25,1.4 4.85,0 3.12,0C1.4,0 0,1.4 0,3.12C0,4.85 1.4,6.25 3.12,6.25C4.85,6.25 6.25,4.85 6.25,3.12Z " />
          <path id="路径 3" fill-rule="evenodd" style="fill: #333333"
          ...
          <path id="路径 5" style="
            ...
            d="M0,0L8.34,4.93 " />
          <path id="路径 6" fill-rule="evenodd" style="fill: #333333"
            transform="translate(18.75 19.999999999999996)  rotate(0 3.1249999999999996 3.1249999999999996)" opacity="1"
