      ...
      <div class="tool-main">
        ...
        <div class="tool-parameter">
          <el-row justify="center">
            <el-col class="parameter-list" :span="12">
              <div class="parameter-name"></div>
              <input
                class="tool-input-width"
                maxlength="2"
  ...
  <el-row :gutter="5" class="tool-menu" justify="center">
    <el-col v-for="item in 1" :span="10">
      <div class="tool-main">
        ...
        <div class="tool-parameter">
          <el-row justify="center">
            <el-col class="parameter-list" :span="18">
              <div class="tool-input-main-up">
                <input
                  class="tool-input-width"
                  maxlength="2"
                  onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[''])[0]"
                  ...
                  value="0.00"
                />
                <div style="font-size: 8px; color: rgb(134, 134, 134)">吊柜/m</div>
              </div>
              <div class="tool-input-main-up">
                <input
                  class="tool-input-width"
                  ...
                  value="0.00"
                />
                <div style="font-size: 8px; color: rgb(134, 134, 134)">地柜/m</div>
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      <div class="tool-main">
        ...
        <div class="tool-parameter">
          <el-row justify="start">
            <el-col class="parameter-list" style="margin-left:10px" :span="12">
              <el-checkbox-group size="small"  v-model="checkList">
                <el-checkbox label="中央空调" />
                <el-checkbox label="地暖" />
                <el-checkbox label="水处理" />
              </el-checkbox-group>
            </el-col>
          </el-row>
        </div>
